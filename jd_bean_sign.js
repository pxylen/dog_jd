...
活动入口：各处的签到汇总
Node.JS专用
IOS软件用户请使用 https://gayhub.lensu.workers.dev/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js
更新时间：2021-4-9
...
async function downFile () {
  ...
  await downloadUrl();
  if ($.body) {
    url = 'https://gayhub.lensu.workers.dev/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js';
  } else {
...
function downloadUrl(url = 'https://gayhub.lensu.workers.dev/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js') {
