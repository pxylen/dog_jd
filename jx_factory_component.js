 ...
 * 点击厂长任务
  quanx:
  [task_local]
  0 1,18 * * * https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory_component.js, tag=京喜工厂plus, img-url=https://gayhub.lensu.workers.dev/58xinian/icon/master/jdgc.png, enabled=true

  Loon:
  [Script]
  cron "0 1,18 * * *" script-path=https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory_component.js,tag=京喜工厂plus

  Surge:
  京喜工厂plus = type=cron,cronexp="0 1,18 * * *",wake-system=1,timeout=20,script-path=https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory_component.js
*
**/
// prettier-ignore
