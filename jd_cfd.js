...
[task_local]
#京喜财富岛
5 8,13,19 * * * https://jdsharedresourcescdn.azureedge.net/jdresource/jd_cfd.js, tag=京喜财富岛, img-url=https://gayhub.lensu.workers.dev/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "5 8,13,19 * * *" script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="5 8,13,19 * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_cfd.js, cronexpr="5 8,13,19 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://gayhub.lensu.workers.dev/gitupdate/updateTeam/master/shareCodes/cfd.json")
