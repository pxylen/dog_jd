 ...
 * 可设置每天通知时间
  quanx:
  [task_local]
  10 * * * * https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory.js, tag=京喜工厂, img-url=https://gayhub.lensu.workers.dev/58xinian/icon/master/jdgc.png, enabled=true

  Loon:
  [Script]
  cron "10 * * * *" script-path=https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory.js,tag=京喜工厂

  Surge:
  京喜工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=20,script-path=https://gayhub.lensu.workers.dev/whyour/hundun/master/quanx/jx_factory.js
*
**/
// prettier-ignore
