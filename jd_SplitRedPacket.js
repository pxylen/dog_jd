...
入口 我的-赚30
更新: 2021-06-09 16:27
https://qxzy.top/rules/QuantumultX/js/zwf234/jd_SplitRedPacket.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#天降红包
30 7 * * * https://qxzy.top/rules/QuantumultX/js/zwf234/jd_SplitRedPacket.js, tag=天降红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "30 7 * * *" script-path=https://qxzy.top/rules/QuantumultX/js/zwf234/jd_SplitRedPacket.js tag=天降红包

===============Surge=================
天降红包 = type=cron,cronexp="30 7 * * *",wake-system=1,timeout=3600,script-path=https://qxzy.top/rules/QuantumultX/js/zwf234/jd_SplitRedPacket.js

============小火箭=========
天降红包 = type=cron,script-path=https://qxzy.top/rules/QuantumultX/js/zwf234/jd_SplitRedPacket.js, cronexpr="30 7 * * *", timeout=3600, enable=true
