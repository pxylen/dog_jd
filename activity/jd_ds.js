 ...
 * @Last Modified by: shylocks https://GITHUB111.com/shylocks
...
参考GITHUB111@jidesheng6修改而来
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#京东代属
10 7 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_ds.js, tag=京东代属, img-url=https://raw.GITHUB111usercontent.com/58xinian/icon/master/jd_ds.png, enabled=true
...
function showMsg() {
  return new Promise(async resolve => {
    ...
    if (nowTime > new Date('2020/12/31 23:59:59+08:00').getTime()) {
      $.msg($.name, '活动已结束', `咱江湖再见\nhttps://GITHUB111.com/LXK9301/jd_scripts`, {"open-url": "https://GITHUB111.com/LXK9301/jd_scripts"});
      if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `咱江湖再见\n https://GITHUB111.com/LXK9301/jd_scripts`)
    } else {
      $.msg($.name, '', `京东账号${$.index} ${$.nickName}\n${message}`);
    }
    resolve()
