...
[task_local]
#jd免费水果
5 6-18/6 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_fruit.js, tag=东东农场, img-url=https://raw.GITHUB111usercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
...
jd免费水果 搬的https://GITHUB111.com/liuxiaoyucc/jd-helper/blob/a6f275d9785748014fc6cca821e58427162e9336/fruit/fruit.js
*/
const $ = new Env('东东农场');
...
async function doFriendsWater() {
  ...
  if (waterFriendCountKey < waterFriendMax) {
    ...
    if ($.friendList.friends && $.friendList.friends.length > 0) {
      ...
      //TODO ,发现bug,GITHUB111 action运行发现有些账号第一次没有给3个好友浇水
